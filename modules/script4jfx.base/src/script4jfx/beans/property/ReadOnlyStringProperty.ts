...
import { StringExpression } from "./../binding/StringExpression";

export abstract class ReadOnlyStringProperty extends StringExpression implements ReadOnlyProperty<string> {
