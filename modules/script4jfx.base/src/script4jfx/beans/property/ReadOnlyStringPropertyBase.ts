...
export abstract class ReadOnlyStringPropertyBase extends ReadOnlyStringProperty {

    private delegate: ReadOnlyPropertyDelegate<string>;

    constructor() {
        super();
        this.delegate = new ReadOnlyPropertyDelegate<string>(this);
    }
