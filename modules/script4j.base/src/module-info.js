...
module.exports = {
    ...
    classes: [
        ...
        'script4j.util.function.Predicate',
        ...
        'script4j.util.AbstractCollection',
        'script4j.util.Set',
        'script4j.util.AbstractSet',
        'script4j.util.HashSet',
        'script4j.util.List',
        'script4j.util.AbstractList',
        'script4j.util.ArrayList',
        'script4j.util.Map',
        'script4j.util.AbstractMap',
        'script4j.util.HashMap',
        'script4j.util.Comparator',
        'script4j.internal.util.RedBlackBinaryTree',
        'script4j.util.SortedMap',
        'script4j.util.TreeMap',
        'script4j.util.Collections',
